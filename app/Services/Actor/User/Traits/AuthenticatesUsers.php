...
use App\Http\Requests\Actor\User\Auth\LoginRequest;
...
trait AuthenticatesUsers
{
	...
	public function showLoginForm()
	{
		...
		return view('actor.user.auth.login')->withSocialiteLinks($this->getSocialLinks());
	}
	...
	protected function handleUserWasAuthenticated(Request $request, $throttles)
	{
		...
		if (! access()->user()->isConfirmed()) {
			$id = access()->user()->id;
			auth()->logout();
			throw new GeneralException(trans('exceptions.app.auth.confirmation.resend', ['user_id' => $id]));
