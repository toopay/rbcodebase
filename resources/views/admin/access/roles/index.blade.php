    ...
    <script>
        $(function() {
            $('#roles-table').DataTable({
                ...
                columns: [
                    {data: 'name', name: '{{config('actor.roles_table')}}.name', render: $.fn.dataTable.render.text()},
                    {data: 'permissions', name: '{{config('actor.permissions_table')}}.display_name', sortable: false},
                    {data: 'users', name: 'users', searchable: false, sortable: false},
                    {data: 'sort', name: '{{config('actor.roles_table')}}.sort', render: $.fn.dataTable.render.text()},
