	...
	<div class="row">
		...
		<div class="col-md-10 col-md-offset-1">
			...
			<div class="panel panel-default">
				<div class="panel-heading"><i class="fa fa-home"></i> {{ trans('labels.app.macros.macro_examples') }}</div>

				<div class="panel-body">
					<div class="form-group">
						<label>{{ trans('labels.app.macros.state.us.us') }}</label>
					...
					<div class="form-group">
						<label>{{ trans('labels.app.macros.country.alpha3') }}</label>
						{!! Form::selectCountryAlpha3('country_alpha3', 'USA', ['class' => 'form-control']) !!}
					</div>
					<div class="form-group">
						<label>{{ trans('labels.app.macros.country.numeric') }}</label>
						{!! Form::selectCountryNumeric('country_numeric', '840', ['class' => 'form-control']) !!}
					</div>
					<div class="form-group">
						<label>{{ trans('labels.app.macros.timezone') }}</label>
