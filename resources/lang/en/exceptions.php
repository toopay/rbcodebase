	...
	'frontend' => [
		'auth' => [
			'confirmation' => [
				...
				'resend' => 'Your account is not confirmed. Please click the confirmation link in your e-mail, or <a href="' . route('actor.user.auth.confirm.resend', ':user_id') . '">click here</a> to resend the confirmation e-mail.',
