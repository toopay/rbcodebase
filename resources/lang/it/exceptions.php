    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Il tuo account non è confermato. Per cortesia clicca sul link di conferma nell\'email che ti abbiamo mandato, o <a href="' . route('actor.user.auth.account.confirm.resend', ':user_id') . '">clicca qui</a> per rimandare l\'email di conferma.',
