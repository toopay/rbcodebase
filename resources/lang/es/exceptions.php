    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Su cuenta no ha sido verificada todavía. Por favor, revise su e-mail, o <a href="' . route('actor.user.auth.account.confirm.resend', ':user_id') . '">pulse aquí</a> para re-enviar el correo de verificación.',
