    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'Du måste bekräfta och aktivera ditt konto för att fortsätta. Bekräfta och aktivera ditt konto genom länken i mailet vi skickade till dig. <a href="' . route('actor.user.auth.account.confirm.resend', ':user_id') . '">Klicka här</a> för att skicka mailet en gång till.',
