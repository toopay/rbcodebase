	...
	'frontend' => [
		'auth' => [
			'confirmation' => [
				...
				'resend' => 'Uw account kon niet worden bevestigd. Klik op de informatie link in de email die u heeft ontvangen, of <a href="' . route('actor.user.auth.confirm.resend', ':user_id') . '">klik hier</a> om de bevestigingsemail opnieuw te versturen.',
