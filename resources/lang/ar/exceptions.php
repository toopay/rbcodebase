	...
	'frontend' => [
		'auth' => [
			'confirmation' => [
				...
				'resend' => 'حسابك غير مفعل. برجاء الضغط على رابط التفعيل الذي تم إرساله إلى بريدك الإلكتروني, أو <a href="' . route('actor.user.auth.confirm.resend', ':user_id') . '">إضغط هنا</a> لإعادة إرسال رابط التفعيل مجددا.',
