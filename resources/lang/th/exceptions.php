    ...
    'frontend' => [
        'auth' => [
            'confirmation' => [
                ...
                'resend' => 'บัญชีผู้ใช้ของคุณยังไม่ได้รับการยืนยันตัวตน กรุณาคลิกลิงก์ในอีเมลของคุณ หรือ <a href="' . route('actor.user.auth.account.confirm.resend', ':user_id') . '">คลิกที่นี่</a> เพื่อส่งอีเมลยืนยันตัวตนอีกครั้ง',
